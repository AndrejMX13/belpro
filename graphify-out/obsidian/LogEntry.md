...
## Connections
- [[A photo attached to a log entry.]] - `uses` [INFERRED]
...
- [[Individual work diary entry submitted by a volunteer.]] - `rationale_for` [EXTRACTED]
...
- [[LogEntryPhoto ORM model — one row per photo, many per log entry.]] - `uses` [INFERRED]
...
- [[create_log_entry()]] - `calls` [INFERRED]
