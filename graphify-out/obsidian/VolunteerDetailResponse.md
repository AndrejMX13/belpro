---
source_file: "D:\Andrej\vsCode-workspace\BelPro\api\schemas\volunteer.py"
type: "code"
...
- [[Volunteer with full entry history — returned by GET volunteers{id}.]] - `rationale_for` [EXTRACTED]
- [[VolunteerResponse]] - `inherits` [EXTRACTED]
- [[Volunteers CRUD router.]] - `uses` [INFERRED]
- [[_to_detail_response()]] - `calls` [INFERRED]
- [[volunteer.py_1]] - `contains` [EXTRACTED]
